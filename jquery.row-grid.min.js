...
a.nextAll().add(a);k(this[0],c,a)}else if(c=h.extend({},h.fn.rowGrid.defaults,c),this.data("grid-options",c),k(this[0],c),c.resize)h(window).on("resize",{container:this[0]},function(a){k(a.data.container,c)});return this};h.fn.rowGrid.defaults={minMargin:null,maxMargin:null,resize:!0,lastRowClass:"last-row",firstItemClass:null}})(jQuery);